<div class="slider-container light rev_slider_wrapper" style="height: 400px;">
  <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 550, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-big arrows-dark' }, 'bullets': {'enable': false, 'style': 'bullets-style-1 bullets-color-primary', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
    <ul>
      ...
      <li data-transition="fade">
        ...
        <div class="tp-caption text-color-light font-weight-normal" data-x="['right','right','center','center']" data-hoffset="['200','200','0','0']" data-y="center" data-voffset="['-72','-72','-72','-125']" data-start="700" data-fontsize="['18','18','18','30']" data-lineheight="['30','30','30','50']" data-transform_in="y:[-50%];opacity:0;s:500;">
          {{ $slide->title }}
        </div>
...
<style>
  ...
  .tp-caption a {
    z-index: 2;
    /* قرار دادن کپشن‌ها و تصاویر در لایه بالاتر از هاله */
  }
