      ...
      <div class="row">
        <div class="col-md-12 align-self-center p-static order-2 text-center">
          <div class="d-flex align-items-center justify-content-center">
            <img src="{{ asset('storage/' . $post->image) }}" class="img-fluid thumbnail-image" alt="{{ $post->title }}">
            <h1 class="text-dark font-weight-bold text-5 ml-3">{{ $post->title }}</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <article class="post post-large blog-single-post border-0 m-0 p-0">
            <div class="post-content ml-0 p-0 rounded bg-white shadow-sm mt-0">
              <div class="post-content ml-0 p-4 rounded bg-white shadow-sm mt-4">
                ...
                <span class="sub-title text-dark bg-gray rounded-border">
                  خلاصه: {!! $post->summary !!}
                </span>
                <style>
                  .bg-gray {
                  ...
                  .rounded-border {
                    ...
                    /* خمیده کردن گوشه‌ها */
                    padding: 10px;
                    /* افزودن فضای داخلی برای بهتر دیده شدن متن */
                    display: inline-block;
                    /* اطمینان از اینکه تغییرات CSS به درستی اعمال می‌شود */
                  }
                </style>
                <p>{!! $post->body !!}</p>
                    ...
                    <li>
                      <div class="comment">
                        <div class="img-thumbnail img-thumbnail-no-borders d-none d-sm-block" style="width: 50px; height: 50px; border-radius: 50%;">
                          <img class="avatar" style="border-radius: 100% !important; width: 100%; height: 100%; object-fit: cover;" alt="{{ $comment->user->first_name }}" src="{{ asset('img/avatars/avatar-2.jpg') }}">
                        </div>
