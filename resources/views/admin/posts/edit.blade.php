    ...
    <div class="card-body">
      ...
      <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea id="summernote1" name="summary" class="form-control" required>{{ old('summary', $post->summary) }}</textarea>
        ...
        <div class="form-group">
          ...
          <textarea id="summernote2" name="body" class="form-control" required>{{ old('body', $post->body) }}</textarea>
          @if($errors->has('body'))
        ...
        <div class="form-group">
          ...
          <select name="published" class="form-control" required>
            <option value="0" {{ old('published', $post->published) == '0' ? 'selected' : '' }}>پیش‌نویس</option>
            <option value="1" {{ old('published', $post->published) == '1' ? 'selected' : '' }}>منتشر شده</option>
          </select>
